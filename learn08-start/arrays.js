function start() {
    ...
    let fLen = months.length;
    let printMonths = "<ul>";
    for (let i = 0; i < fLen; i++) {
    printMonths += "<li>" + months[i] + "</li>";
    }      
    printMonths += "</ul>";

    document.getElementById("months").innerHTML = printMonths
    ...
    let stringList = months.toString();
    document.getElementById("string").innerHTML = stringList
